...
import keenana.BasicWord;
import keenana.Bigram;
import keenana.Driver;
import keenana.VocabularyEntry;
import keenana.Word;
...
public class Lab13Tests {
    ...
    public void basicWord() {
        ...
        try {
            ...
            Assertions.assertThrows(UnsupportedOperationException.class, () -> bw1.addLocation(1L));
    ...
    public void addVocabulary() {
        try {
            ...
            Assertions.assertEquals(3, ((VocabularyEntry)vocabulary.get(0)).getOccurences());
